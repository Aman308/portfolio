...
export const HeroSection = () => {
  ...
  <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <div className='size-[1220px] hero-ring'></div>
     ...
     <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration="34s" shouldSpin spinDuration='7s'>
    ...
    <HeroOrbit size={590} rotation={98} shouldOrbit orbitDuration="40s"shouldSpin spinDuration='7s'>
     ...
     <HeroOrbit size={720} rotation={85} shouldOrbit orbitDuration="46s"shouldSpin spinDuration='7s'>
      <div className="size-3 rounded-full bg-emerald-300/20"/>
     </HeroOrbit>
    ...
    <div className="container">
      ...
      <h1 className='font-serif text-3xl md:text-4xl text-center mt-8 tracking-wide'>Building Exceptional User Experience</h1>
      <p className='mt-4 text-center text-white/60 md:text-[16px]'>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
        <button onClick={scrollToProject} className=' inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl z-10'>
          <span className='font-semibold' id='project'>Explore My Work</span>
        ...
        <button className='  inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl z-10'>
          <span >👋</span>
          <span  onClick={scrollToContact} className='font-semibold '>Lets Connect</span>
        </button>
      </div>
    </div>
  </div>
